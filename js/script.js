...
//запрос имени пользвоателя и сохранение пользователя в куки. ?????выбор пользователя из тех кто уже посещал сайт?????
//leaderboard
//score(?)
//мобильная верстка
//управление на мобильном
//посказки при первой игре
//дополнительные очки за то, что игрок убирает весь ряд и за проход уровня
//обработка отбития от платформы(при попадании в бок платформы мяч залитает в нее или под нее, исправить)
//анимация выпадения бонуса
//СДЕЛАТЬ АДЕКВАТНУЮ ФИЗИКУ!!!!!
// fix scorecomputing
//добавить уровни
